...
const ThemeSwitcher: React.FC<ThemeSwitcherProps> = ({ visible, onClose }) => {
  const { theme, themeName, setTheme, availableThemes } = useTheme();

  const handleThemeSelect = (selectedTheme: string) => {
    Logger.debug('Theme selection', { oldTheme: themeName, newTheme: selectedTheme });
    setTheme(selectedTheme);
    Logger.info('Theme changed successfully', { theme: selectedTheme });
    onClose();
  };
