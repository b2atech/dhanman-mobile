...
const DeliveryPreEntry = () => {
  const route = useRoute();
  const initialTab = route.params?.type || 'Once';
  ...
  useEffect(() => {
    if (route.params?.type) {
      setSelectedTab(route.params.type);
    }
  }, [route.params?.type]);
  ...
  const handleCompanySelection = selectedCompanyName => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <Text style={styles.header}>Delivery Entry Type</Text>
      ...
      <View style={styles.deliveryCard}>
        <View style={styles.tabWrapper}>
          ...
          <TouchableOpacity
            style={[
              styles.tabButton,
              selectedTab === 'Frequent' && styles.activeTabButton,
            ]}
            onPress={() => setSelectedTab('Frequent')}>
            <Text
              style={[
                styles.tabText,
                selectedTab === 'Frequent' && styles.activeTabText,
              ]}>
              Frequently
            </Text>
          </TouchableOpacity>
        ...
        {selectedTab === 'Once' ? (
          <View style={styles.formContainer}>
            <Text style={styles.label}>
              Allow my delivery to enter today once in next
            </Text>
        ...
        {companyName && (
          <Text style={commonStyles.headerText}>Company: {companyName}</Text>
        )}
...
export default DeliveryPreEntry;
